...
bright = cv2.imread('cubes_outdoor.png')
dark = cv2.imread('cube_indoor.png')

if bright is None:
    raise FileNotFoundError("Could not read cube_outdoor.png")
if dark is None:
    raise FileNotFoundError("Could not read cube_indoor.png")


rightLAB = cv2.cvtColor(bright, cv2.COLOR_BGR2LAB)
